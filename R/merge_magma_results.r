...
merge_magma_results <- function(ctAssoc1,ctAssoc2){
    ...
    if(ctAssoc1$gwas_sumstats_path==ctAssoc2$gwas_sumstats_path){ctAssoc$gwas_sumstats_path=ctAssoc2$gwas_sumstats_path}
    if(ctAssoc1$total_baseline_tests_performed==ctAssoc2$total_baseline_tests_performed){ctAssoc$total_baseline_tests_performed=ctAssoc2$total_baseline_tests_performed}
    if(ctAssoc1$upstream_kb==ctAssoc2$upstream_kb){ctAssoc$upstream_kb=ctAssoc2$upstream_kb}
    if(ctAssoc1$downstream_kb==ctAssoc2$downstream_kb){ctAssoc$downstream_kb=ctAssoc2$downstream_kb}
    if(ctAssoc1$genome_ref_path==ctAssoc2$genome_ref_path){ctAssoc$genome_ref_path=ctAssoc2$genome_ref_path}
