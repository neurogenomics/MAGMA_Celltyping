...
#'
#' @export
calculate_celltype_associations_in_top10percent <- function(ctd,gwas_sumstats_path,analysis_name="MainRun",upstream_kb=10,downstream_kb=1.5,genome_ref_path,specificity_species="mouse"){
