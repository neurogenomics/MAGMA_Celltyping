...
multiple types of summary statistics files:
[`MungeSumstats`](https://www.biorxiv.org/content/10.1101/2021.06.21.449239v1)
(please cite the associated publication if you use this package). We
will use `Mungesumstats` here to reformat the summary statistics for
Fluid Intelligence. The criteria we need to meet for information after
formatting is:
