...
First we need to calculate the quantile groups for each celltype within the single-cell dataset. This is done using the `prepare_quantile_groups` function. If your single-cell dataset is not from mouse, then change the `ctd_species` argument.
...
output <- MAGMA.Celltyping::calculate_celltype_enrichment_probabilities_wtLimma(
...
To test whether a gene set (in HGNC or MGI format) is enriched 
